...
function mockDetailedVision(): DetailedVisionResult {
  const scenarios = [
    { objects: ['streetlight pole', 'light fixture'], materials: ['metal pole', 'concrete base'], conditions: ['dark', 'not working'], context: 'residential area', confidence: 0.90 },
    { objects: ['pothole', 'road surface', 'pavement'], materials: ['asphalt', 'concrete'], conditions: ['large crack', 'deep hole', 'broken'], context: 'school zone', confidence: 0.88 },
    { objects: ['garbage pile', 'drain cover', 'roadside'], materials: ['plastic waste', 'organic waste', 'metal'], conditions: ['overflowing', 'blocking drain', 'accumulated'], context: 'market area', confidence: 0.85 },
    { objects: ['water pipe', 'road surface'], materials: ['metal pipe', 'water', 'asphalt'], conditions: ['leaking', 'burst', 'flooding'], context: 'highway', confidence: 0.92 }
  ]
